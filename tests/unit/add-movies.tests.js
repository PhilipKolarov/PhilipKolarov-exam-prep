...
suite('Add Movies page', function() {
  test('Page title', async function() {
    let res = await fetch("hhttps://philipkolarov-movies.onrender.com/");
  ...
  test('Add valid movie', async function() {
    let res = await fetch(
      "https://philipkolarov-movies.onrender.com/",
      {
        method: 'POST',
        headers: {
  ...
  test('Add invalid movie', async function() {
    ...
    res = await fetch("https://philipkolarov-movies.onrender.com/");
    body = await res.text();
